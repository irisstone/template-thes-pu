...
\title{Latent variable models for quantifying and interpreting complex behaviors}
...
\include{ch1-intro/chapter-intro}
\include{ch2-glmhmm/chapter-glmhmm}
\include{ch3-slds/chapter-slds}
\include{ch4-bestlds/chapter-bestlds}
%\include{ch5-fastslds/chapter-fastslds}
%\include{ch-usage/chapter-usage}
\include{ch6-conclusion/chapter-conclusion}
\appendix % all chapters following will be labeled as appendices
\include{ch7-appendix1/chapter-appendix1}
\include{ch8-appendix2/chapter-appendix2}
